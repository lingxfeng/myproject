...
public class WeixinBaseAction extends AbstractPageCmdAction {
    ...
    public Page doShowNewsItem(WebForm form) {
        ...
        return new Page("/" + newsItem.getTenant().getCode() + "/" + newsItem.getTpl().getAccount().getCode() + "/news/defaultItem.html");
    }
    ...
    public Page doJfzx(WebForm form) {
        ...
        return new Page("/" + follower.getTenant().getCode() + "/" + follower.getAccount().getCode() + "/news/points.html");
    }
    ...
    public Page doJfcj(WebForm form) {
        ...
        form.addResult("scorepoints", follower.getScorepoints());
        return new Page("/" + follower.getTenant().getCode() + "/" + follower.getAccount().getCode() + "/news/jfcj.html");
    }
