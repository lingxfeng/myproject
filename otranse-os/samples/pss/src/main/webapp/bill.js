...
ProductGridList=Ext.extend(Disco.Ext.BaseGridList,{
 url:"product.java?cmd=list",
...
OrderInfoPanel=Ext.extend(Disco.Ext.CrudMainDetailPanel,{
    id:"orderInfoPanel",
    title:"销售订单管理",
    baseUrl:"orderInfo.java",
    billName:"销售订单",
    typesData:[["普通",0],["其它",1]],
    ...
    var formPanel=new Ext.form.FormPanel({
        ...
        Disco.Ext.Util.columnPanelBuild(5,{ fieldLabel:'单据编号',name:'sn'  },
       Disco.Ext.Util.buildCombox('types', '类别', this.typesData, 0, true), 
 {xtype:"datefield", fieldLabel:'业务时间',name:'vdate' ,format:"Y-m-d"  },this.buildRemoteCombox("client","客户","client.java?cmd=list",["id","name"],"name","id"),this.buildRemoteCombox("seller","业务员","employee.java?cmd=list",["id","trueName"],"trueName")
...
PurchaseBillPanel=Ext.extend(Disco.Ext.CrudMainDetailPanel,{
    id:"purchaseBillPanel",
    title:"采购单管理",
    baseUrl:"purchaseBill.java",
    billName:"采购单",
    typesData:[["普通",0],["其它",1]],
...
Disco.Ext.Util.columnPanelBuild(5,{ fieldLabel:'编号',name:'sn'  },
Disco.Ext.Util.buildCombox('types', '类别' , this.typesData, 0),
 {xtype:"datefield", fieldLabel:'日期',name:'vdate' ,format:"Y-m-d",value:new Date()  },
this.buildRemoteCombox("supplier","供应商","supplier.java?cmd=list",["id","name"],"name","id"),
this.buildRemoteCombox("buyer","采购员","employee.java?cmd=list",["id","trueName"],"trueName","id")),
{xtype:"textfield",fieldLabel:'备注',name:'remark',anchor:"-20"}
    ]},
	...
	{header: "供应商", sortable:true,width: 300, dataIndex:"supplier",renderer:this.objectRender("id")},
	{header: "采购员", sortable:true,width: 300, dataIndex:"buyer",renderer:this.objectRender("id")},
	{header: "审核人", sortable:true,width: 300, dataIndex:"auditor",renderer:this.objectRender("id")}
        ]);
...
StockIncomePanel=Ext.extend(Disco.Ext.CrudMainDetailPanel,{
    id:"stockIncomePanel",
    title:"入库单管理",
...
Disco.Ext.Util.columnPanelBuild(5,{ fieldLabel:'编号',name:'sn',allowBlank:false},
{xtype:"datefield", fieldLabel:'日期',name:'vdate' ,format:"Y-m-d",value:new Date()},
Ext.apply({},{allowBlank:false},this.buildRemoteCombox("depot","仓库","depot.java?cmd=list",["id","name"],"name","id")),
this.buildRemoteCombox("keeper","库管员","employee.java?cmd=list",["id","trueName"],"trueName","id"),
this.buildRemoteCombox("supplier","供应商","supplier.java?cmd=list",["id","name"],"name","id")
),
{ xtype:"textfield",fieldLabel:'备注',name:'remark',anchor:"-20"  }
    ]},
...
StockOutcomePanel=Ext.extend(Disco.Ext.CrudMainDetailPanel,{
    ...
    var formPanel=new Ext.form.FormPanel({
       ...
       items:[{region:"north",autoHeight:true,layout:"form",items:[{xtype:"hidden",name:"id"},
       {xtype:"hidden", fieldLabel:'类别',name:'types',value:(this.baseQueryParameter?this.baseQueryParameter.types||0:0)  },
Disco.Ext.Util.columnPanelBuild(5,       
{ fieldLabel:'编号',name:'sn',allowBlank:false},
{xtype:"datefield", fieldLabel:'日期',name:'vdate' ,format:"Y-m-d",value:new Date()  },
Ext.apply({},{allowBlank:false},this.buildRemoteCombox("depot","仓库","depot.java?cmd=list",["id","name"],"name","id")),
this.buildRemoteCombox("client","客户","client.java?cmd=list",["id"]),
this.buildRemoteCombox("keeper","库管员","employee.java?cmd=list",["id"])),
...
ProductStockPanel=Ext.extend(Disco.Ext.BaseGridList,{
    id:"productStockPanel",
    title:"即时库存",
    url:"productStock.java?cmd=list",
    storeMapping:["id","storeNum","price","totalAamount","incomeDate","outcomeDate","warning","topNum","bottomNum"    ,"product","depot"    ],
    search:function(){
        
    },
    initComponent : function(){
    this.search_depot=new  Ext.form.ComboBox(Disco.Ext.Util.buildRemoteCombox("depot","仓库","depot.java?cmd=list",["id","name"],"name","id"));
    this.search_sn=new Ext.form.TextField({name:"sn"})
    ...
    this.cm=new Ext.grid.ColumnModel([
{header: "仓库", sortable:true,width: 300, dataIndex:"depot",renderer:this.objectRender("id")},      
{header: "货品名称", sortable:true,width: 300, dataIndex:"product",renderer:this.objectRender("title")},
...
{header: "金额", sortable:true,width: 300, dataIndex:"totalAamount" },
...
BaseReportChartPanel=Ext.extend(Disco.Ext.BaseGridList,{
    reset:function(){
...
PurchaseReportPanel=Ext.extend(BaseReportChartPanel,{
    ...
    title:"采购报表",
    url:"purchaseBill.java?cmd=statistics",
    ...
    initComponent : function(){
    this.search_supplier=new  Ext.form.ComboBox(Ext.apply({},{width:100},this.buildRemoteCombox("supplier","供应商","supplier.java?cmd=list",["id","name"],"name","id")));
    this.search_sn=new Ext.form.TextField({name:"sn",width:60});
    this.search_name=new Ext.form.TextField({name:"name",width:60});
    this.search_dir=new Disco.Ext.TreeComboField(Ext.apply({},{width:100},Disco.Ext.Util.buildRemoteTreeCombox("dir", "分类", "productDir.java?cmd=getTree", "name","id", "parent","所有分类")));
    ...
    this.search_buyer=new Ext.form.ComboBox(Ext.apply({},{width:80},this.buildRemoteCombox("buyer","采购员","employee.java?cmd=list",["id","name","trueName"],"trueName","id")));
...
OrderInfoReportPanel=Ext.extend(BaseReportChartPanel,{
    ...
    title:"销售报表",
    url:"orderInfo.java?cmd=statistics",
    storeMapping:["id","title","value","num","amount"],
    searchResult:function(groupBy){
        return function(){
    ...
    initComponent : function(){
    this.search_client=new  Ext.form.ComboBox(Ext.apply({},{width:100},this.buildRemoteCombox("client","客户","client.java?cmd=list",["id","name"],"name","id")));
    this.search_sn=new Ext.form.TextField({name:"sn",width:60});
    this.search_name=new Ext.form.TextField({name:"name",width:60});
    this.search_dir=new Disco.Ext.TreeComboField(Ext.apply({},{width:100},Disco.Ext.Util.buildRemoteTreeCombox("dir", "分类", "productDir.java?cmd=getTree", "name","id", "parent","所有分类")));
    this.search_vdate1=new Ext.form.DateField({name:"vdate1",format:"Y-m-d"});
    this.search_vdate2=new Ext.form.DateField({name:"vdate2",format:"Y-m-d"});
    this.search_seller=new Ext.form.ComboBox(Ext.apply({},{width:80},this.buildRemoteCombox("seller","业务员","employee.java?cmd=list",["id","name","trueName"],"trueName","id")));
...
StockDetailTotalReportPanel=Ext.extend(BaseReportChartPanel,{
    ...
    title:"进销存汇总表",
    url:"stockDetailAccount.java?cmd=statisticsTotal",
...
StockDetailAccountReportPanel=Ext.extend(BaseReportChartPanel,{
    ...
    title:"进销存明细帐",
    url:"stockDetailAccount.java?cmd=statistics",
    ...
    this.search_vdate1=new Ext.form.DateField({name:"vdate1",format:"Y-m-d"});
    this.search_vdate2=new Ext.form.DateField({name:"vdate2",format:"Y-m-d"});
    this.search_depot=new Ext.form.ComboBox(Ext.apply({},{width:80},this.buildRemoteCombox("depot","仓库","depot.java?cmd=list",["id","name"],"name","id",false)));
