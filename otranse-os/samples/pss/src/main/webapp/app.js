...
DepartmentPanel=Ext.extend(Disco.Ext.CrudPanel,{
    id:"departmentPanel",
    title:"部门列表",
...
{xtype:"treecombo",fieldLabel:"上级部门",name:"parent",hiddenName:"parent",tree:new   Ext.tree.TreePanel({
                            loader : new Ext.tree.TreeLoader({
                                        url : "department.java?cmd=getTree",
...
DepotPanel=Ext.extend(Disco.Ext.CrudPanel,{
    id:"depotPanel",
    title:"仓库管理",
    baseUrl:"depot.java",
  ...
  Disco.Ext.Util.buildCombox('types', '类别', this.typesData),
...
{fieldLabel:'用户名',name:'name'},
    ...
    Disco.Ext.Util.buildCombox("sex","性别",this.sexData,"",true),
    ...
    Disco.Ext.Util.buildCombox("types","用户类别",this.typesData,0)),
...
ProductDirPanel=Ext.extend(Disco.Ext.CrudTreePanel,{
    id:"productDirPanel",
    title:"产品分类管理",
    baseUrl:"productDir.java",
    treeTitle:"分类树",
    rootTitle:"全部分类",
    createForm:function(){
    var formPanel=new Ext.form.FormPanel({
    ...
    Disco.Ext.Util.buildRemoteTreeCombox("parent", "父目录", "productDir.java?cmd=getTree", "name","id", "parent","所有分类"),
...
ProductPanel=Ext.extend(Disco.Ext.CrudPanel,{
    id:"productPanel",
    title:"货品管理",
    baseUrl:"product.java",
    showExportData:true,
    showImportData:true,
    createForm:function(){
    var formPanel=new Ext.form.FormPanel({
...
{ fieldLabel:'名称',name:'name',allowBlank:false},
{ fieldLabel:'编号',name:'sn',allowBlank:false},
Disco.Ext.Util.buildRemoteTreeCombox("dir", "分类", "productDir.java?cmd=getTree", "name","id", "parent","所有分类"),
this.buildRemoteCombox("brand","品牌","systemDictionaryDetail.java?cmd=list&parentSn=ProductBrand",["id","title"],"title"),
this.buildRemoteCombox("unit","单位","systemDictionaryDetail.java?cmd=list&parentSn=ProductUnit",["id","title"],"title"),
...
SystemDictionaryPanel=Ext.extend(Disco.Ext.CrudPanel,{
...
SystemDictionaryDetailPanel=Ext.extend(Disco.Ext.CrudPanel,{
    ...
    Disco.Ext.Util.buildRemoteCombox("parent","所属字典","systemDictionary.java?cmd=list",["id","title"],"title","id"),
    {fieldLabel:'排序',name:'sequence'},
...
this.buildRemoteCombox("types","类别","systemDictionaryDetail.java?cmd=list&parentSn=ClientTypes",["id","title"],"title","id"),
this.buildRemoteCombox("source","来源","systemDictionaryDetail.java?cmd=list&parentSn=ClientSource",["id","title"],"title","id"),
this.buildRemoteCombox("trade","行业","systemDictionaryDetail.java?cmd=list&parentSn=Trade",["id","title"],"title","id"),
this.buildRemoteCombox("seller","业务员","employee.java?cmd=list",["id","name","trueName"],"trueName","id"),
...
Disco.Ext.Util.buildCombox('status', '状态', this.statusData, 0)
),
...
SupplierPanel=Ext.extend(Disco.Ext.CrudPanel,{
    id:"supplierPanel",
    title:"供应商管理",
...
ChangePasswordWindow = Ext.extend(Ext.Window, {
    ...
    save : function() {
        ...
        this.fp.getForm().submit({
                    url : "employee.java?cmd=changePassword",
                    waitMsg : "正在保存",
                    waitTitle : "请稍候",
