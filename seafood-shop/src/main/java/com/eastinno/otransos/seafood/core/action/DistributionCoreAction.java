...
public class DistributionCoreAction extends WxShopBaseAction{
    ...
    public Page doCalculateDistri(WebForm form){
		...
		qo.setPageSize(-1);
		List<ShopDistributor> list1 = this.shopDistributorService.getShopDistributorBy(qo).getResult();
		levelone = list1.size();
		...
		qo2.addQuery("obj.disType",1,"=");
		qo2.addQuery("obj.status",1,"=");
		qo2.setPageSize(-1);
		List<ShopDistributor> list2 = this.shopDistributorService.getShopDistributorBy(qo2).getResult();
		total = list2.size();
		
		//统计三级分销商数量
		QueryObject qo3 = new QueryObject();
		qo3.addQuery("obj.disType",1,"=");
		qo3.addQuery("obj.status",1,"=");
		qo3.addQuery("obj.parent is not null");
		qo3.addQuery("obj.parent.disType",1,"=");
		qo3.addQuery("obj.parent.status",1,"=");
		qo3.setPageSize(-1);
		List<ShopDistributor> list3 = this.shopDistributorService.getShopDistributorBy(qo3).getResult();
